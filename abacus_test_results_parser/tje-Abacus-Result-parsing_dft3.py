...
def get_script_results_info(script):
    ...
    return CC, SC, call_attemps_per_sec, Total_call_attempts,Total_Script_attempts, call_cycles

#MAIN
Result_XML = "C:/Abacus_Results/BBDLC_CPOTS_BulkCall_LoadTest_via_CrossConnects.xml"
script = "N26S3-48p"
root = " "
Result_XML = open_the_xml_report(Result_XML)
...
CC, SC, call_attemps_per_sec, Total_call_attempts,Total_Script_attempts, call_cycles = get_script_results_info(script)
print CC
print SC
print call_attemps_per_sec
print Total_call_attempts
print Total_Script_attempts
print call_cycles
#
